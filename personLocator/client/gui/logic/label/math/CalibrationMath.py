...
class CalibrationMath:
    ...
    def evaluate_raycast_precision(px: int, py: int, ideal_3d: np.ndarray,
                                   ...
                                   custom_rectangles: list, img_size: tuple = (1920, 1080)) -> dict:

        real_3d = GeometryMath.project_2d_to_3d(px, py, pixel_points, world_points,
                                                custom_rectangles, target_y=ideal_3d[1], img_size=img_size)
    ...
    def analyze_body_metrics(keypoints: list, pos_3d: np.ndarray,
                             ...
                             frame: np.ndarray = None, custom_rectangles: list = None,
                             img_size: tuple = (1920, 1080)) -> dict:
        metrics = {
        ...
        skeleton_3d = GeometryMath.lift_skeleton_to_3d(keypoints, pos_3d, pixel_points, world_points, custom_rectangles, img_size=img_size)
    ...
    def calculate_person_height(pixel_bbox: list,
                                ...
                                img_size: tuple = (1920, 1080)) -> Tuple[float, bool]:
